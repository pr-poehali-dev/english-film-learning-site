...
export const mockMovies: Movie[] = [
  {
    ...
    duration: '2ч 22мин',
    description: 'Классическая история о надежде, дружбе и свободе в стенах тюрьмы Шоушенк.',
    watched: true,
    testPassed: true,
    subtitles: [
      {
  ...
  },
  {
    ...
    duration: '2ч 22мин',
    description: 'История простого человека с добрым сердцем, чья жизнь стала отражением эпохи.',
    watched: false,
    testPassed: false,
    subtitles: [
      {
        ...
        words: [
          { word: 'chocolates', translation: 'шоколадные конфеты', partOfSpeech: 'n' },
        ]
      },
      {
        id: 2, start: 5, end: 9,
  ...
  },
  {
    ...
    duration: '1ч 57мин',
    description: 'Реальная история отца, который не сдался перед трудностями жизни.',
    watched: false,
    testPassed: false,
    subtitles: [
      {
  ...
  },
  {
    ...
    duration: '2ч 28мин',
    description: 'Профессиональный вор, специализирующийся на похищении секретов из подсознания.',
    watched: false,
    testPassed: false,
    subtitles: [],
  },
  {
    ...
    level: 'B2',
    poster: 'https://images.unsplash.com/photo-1558171813-9c5b2c6f499d?w=400&h=600&fit=crop',
    duration: '1ч 49мин',
    description: 'Молодая журналистка устраивается ассистентом к властной редактору модного журнала.',
    watched: false,
    testPassed: false,
    subtitles: [],
  },
  {
    ...
    duration: '2ч 06мин',
    description: 'Гениальный юноша из Бостона и его путь к признанию своего дара.',
    watched: false,
    testPassed: false,
    subtitles: [],
  },
...
export const mockDictionary: DictionaryWord[] = [
  { id: 1, word: 'remind', translation: 'напоминать', partOfSpeech: 'v', movieTitle: 'The Shawshank Redemption', addedAt: '2026-02-20', learned: false },
  { id: 2, word: 'caged', translation: 'в клетке', partOfSpeech: 'adj', movieTitle: 'The Shawshank Redemption', addedAt: '2026-02-20', learned: true },
  { id: 3, word: 'feathers', translation: 'перья', partOfSpeech: 'n', movieTitle: 'The Shawshank Redemption', addedAt: '2026-02-19', learned: false },
  { id: 4, word: 'hope', translation: 'надежда', partOfSpeech: 'n', movieTitle: 'The Shawshank Redemption', addedAt: '2026-02-18', learned: true },
  { id: 5, word: 'pursuit', translation: 'погоня, стремление', partOfSpeech: 'n', movieTitle: 'The Pursuit of Happyness', addedAt: '2026-02-17', learned: false },
  { id: 6, word: 'redemption', translation: 'искупление', partOfSpeech: 'n', movieTitle: 'The Shawshank Redemption', addedAt: '2026-02-16', learned: false },
];
    ...
    questions: [
      {
        ...
        options: ['Robbery', 'Murder of his wife', 'Fraud', 'Escape from prison'],
        correct: 1,
      },
      {
        id: 2,
