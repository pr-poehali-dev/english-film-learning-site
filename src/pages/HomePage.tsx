  ...
  return (
    <div className="min-h-screen pb-20 md:pb-0">
      ...
      <section className="relative overflow-hidden">
        {/* Background blobs */}
        <div
          className="absolute top-0 left-0 w-72 h-72 md:w-96 md:h-96 rounded-full opacity-60 -translate-x-1/3 -translate-y-1/4"
          style={{ backgroundColor: "#d98c8c" }}
        />
        <div
          className="absolute bottom-0 right-0 w-80 h-80 md:w-[500px] md:h-[500px] rounded-full opacity-40 translate-x-1/4 translate-y-1/4"
          style={{ backgroundColor: "#d98c8c" }}
        />
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-16 md:py-24 flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1 z-10">
            ...
            <p
              className="text-muted-foreground text-base md:text-lg mb-8 animate-fade-in"
          ...
          <div
            className="flex-1 flex justify-center z-10 animate-fade-in"
      ...
      <section className="relative overflow-hidden py-16 md:py-24">
        <div
          className="absolute top-0 left-0 w-64 h-64 md:w-80 md:h-80 rounded-full opacity-40 -translate-x-1/3 translate-y-1/4"
          style={{ backgroundColor: "#d98c8c" }}
        />
        <div
          className="absolute bottom-0 right-0 w-72 h-72 md:w-96 md:h-96 rounded-full opacity-30 translate-x-1/4 -translate-y-1/4"
          style={{ backgroundColor: "#d98c8c" }}
        />
            ...
            {features.slice(0, 4).map((f, i) => (
              ...
              >
                ...
                <div
                  ...
                  style={{ backgroundColor: "#d98c8c20" }}
                >
                  <Icon
                    name={f.icon}
                    size={20}
      ...
      <footer className="py-8 text-center border-t border-border">
        <p className="font-bold font-golos text-foreground text-base mb-1">
          EngFil
        </p>
